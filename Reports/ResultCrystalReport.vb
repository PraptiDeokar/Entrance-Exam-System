...
Public Class ResultCrystalReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EntranceExamApplication.ResultCrystalReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedResultCrystalReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ResultCrystalReport = New ResultCrystalReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
