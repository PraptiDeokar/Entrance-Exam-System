...
Public Class RgsCrystalReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EntranceExamApplication.RgsCrystalReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRgsCrystalReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RgsCrystalReport = New RgsCrystalReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
