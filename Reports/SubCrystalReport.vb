...
Public Class SubCrystalReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EntranceExamApplication.SubCrystalReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSubCrystalReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SubCrystalReport = New SubCrystalReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
